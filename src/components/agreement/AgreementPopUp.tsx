            ...
            if (alreadyAggree && !JSON.parse(alreadyAggree)) {
                return (
                    ...
                    >
                        ...
                        <Modal.Content>
                            <p>
                                Welcome to the RescueDen Den. The RescueDen will serve as your central location for all
                                things CAWS. In addition to the CAWS Privacy Policy (caws.org/privacy) and RescueDen
                                Privacy Policy(rescueden.org/privacy) you also acknowledge that:
                                <List>
                                    <List.Item>
